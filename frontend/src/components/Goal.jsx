...
function Goal({ name, current_amount, currency, idGoal,fetchGoals }) {
  const { id } = useParams();
    ...
    <div>
      <div className="flex border-2 rounded-lg border-gray-200 border-opacity-50 p-5 mb-8 sm:flex-row flex-col bg-light-grey items-center">
        ...
        <div className="flex-1">
          <div className='flex justify-between'>
            ...
            <div className='self-center'>
              {id == null && 
                <button onClick={editGoal} className="btn btn-primary">
        ...
        <div className="mt-4 w-full bg-gray-300 rounded-full dark:bg-gray-700">
            <div className="bg-indigo-600 text-xs font-medium text-blue-100 text-center p-1 leading-none rounded-full" style={{ width:'45%' }}> 45%</div>
        </div>
