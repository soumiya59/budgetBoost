function Pricing() {
    return (
        <section className="text-beig-light body-font overflow-hidden h-screen">
  <div className="container px-5 py-24 mx-auto">
    ...
    <div className="flex flex-wrap -m-4">
      <div className="p-4 xl:w-1/4 md:w-1/2 w-full">
        <div className="h-full p-6 rounded-lg border-2 border-gray-300 flex flex-col relative overflow-hidden bg-mat-blue">
          <h2 className="text-sm tracking-widest title-font mb-1 font-medium">START</h2>
          <h1 className="text-5xl text-light-grey pb-4 mb-4 border-b border-gray-200 leading-none">Free</h1>
          <p className="flex items-center text-beig-light mb-2">
          ...
          <p className="flex items-center text-beig-light mb-6">
            <span className="w-4 h-4 mr-2 inline-flex items-center justify-center bg-gray-400 text-white rounded-full flex-shrink-0">
              <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" className="w-3 h-3" viewBox="0 0 24 24">
                <path d="M20 6L9 17l-5-5"></path>
              </svg>
      ...
      <div className="p-4 xl:w-1/4 md:w-1/2 w-full">
        <div className="h-full p-6 rounded-lg border-2 border-purple-friend  flex flex-col relative overflow-hidden bg-mat-blue">
          ...
          <h1 className="text-5xl text-light-gery leading-none flex items-center pb-4 mb-4 border-b border-gray-200">
            <span>$38</span>
      ...
      <div className="p-4 xl:w-1/4 md:w-1/2 w-full">
        <div className="h-full p-6 rounded-lg border-2 border-gray-300 flex flex-col relative overflow-hidden bg-mat-blue">
          ...
          <h1 className="text-5xl text-light-grey leading-none flex items-center pb-4 mb-4 border-b border-gray-200">
            <span>$72</span>
